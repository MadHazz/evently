...
evently/
  ...
  apps/
    ...
    web/              # Next.js (not Dockerized yet)
...
- [x] Root `docker-compose.yml` with Postgres (5436), Redis, and API
...
- [x] Jest unit tests set up
- [x] Jest e2e tests (Supertest)
- [x] Test database strategy
- [x] Tests for `/health` and `/db-check`
